...
{
	#region FDepartmentBak
	/// <summary>
	/// This object represents the properties and navigation list of a FDepartmentBak.
	/// </summary>
    [Serializable]
    [Table("F_DepartmentBak")]
	public class FDepartmentBak
	{
		
		public FDepartmentBak()
		{
		}
